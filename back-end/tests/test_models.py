...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_password_hashing(self):
        u = User(username='garen')
        u.set_password('pwd123')
        self.assertTrue(u.check_password('pwd123'))
        self.assertFalse(u.check_password('saldkjflkdjf'))
    ...
    def test_follow_posts(self):
        ...
        f1 = u1.followeds_posts().all()
        f2 = u2.followeds_posts().all()
        f3 = u3.followeds_posts().all()
        f4 = u4.followeds_posts().all()
